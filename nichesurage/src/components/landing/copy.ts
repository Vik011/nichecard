...
export const COPY = {
  en: {
    ...
    features: [
      ...
      { icon: 'sparkles', tier: 'premium', title: 'AI Clone & Twist', desc: 'Claude shows you exactly how to replicate a viral format with your unique spin.' },
  ...
  de: {
    ...
    features: [
      ...
      { icon: 'sparkles', tier: 'premium', title: 'KI Clone & Twist', desc: 'Claude zeigt dir, wie du ein virales Format mit deinem eigenen Twist replizierst.' },
