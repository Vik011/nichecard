...
export default function PrivacyPage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-ink-subtle text-sm mb-10">Last updated: {LAST_UPDATED}</p>
      ...
      <ul className="text-ink-muted leading-relaxed mb-4 list-disc list-inside space-y-2">
        ...
        <li>
          <span className="text-ink-muted font-medium">Subscription data</span>{" "}
        ...
        <li>
          <span className="text-ink-muted font-medium">Usage data</span> —
          niches you save, AI features you trigger (Niche Health Check, Content
          Angles), and per-day quota counters.
        </li>
        <li>
          <span className="text-ink-muted font-medium">Product analytics</span>{" "}
        ...
        <li>
          <span className="text-ink-muted font-medium">Error telemetry</span>{" "}
      ...
      <ul className="text-ink-muted leading-relaxed mb-4 list-disc list-inside space-y-2">
        <li>
          <span className="text-ink-muted font-medium">Supabase</span> —
        ...
        <li>
          <span className="text-ink-muted font-medium">Stripe</span> — payment
        ...
        <li>
          <span className="text-ink-muted font-medium">Vercel</span> — hosting
        ...
        <li>
          <span className="text-ink-muted font-medium">Resend</span> —
        ...
        <li>
          <span className="text-ink-muted font-medium">PostHog</span> —
        ...
        <li>
          <span className="text-ink-muted font-medium">Sentry</span> — error
        ...
        <li>
          <span className="text-ink-muted font-medium">Cloudflare</span> —
        ...
        <li>
          <span className="text-ink-muted font-medium">Anthropic</span> — AI
        ...
        <li>
          <span className="text-ink-muted font-medium">OpenAI</span> —
        ...
        <li>
          <span className="text-ink-muted font-medium">YouTube Data API</span>{" "}
      ...
      <ul className="text-ink-muted leading-relaxed mb-4 list-disc list-inside space-y-2">
        <li>
          <span className="text-ink-muted font-medium">Right of access</span>{" "}
