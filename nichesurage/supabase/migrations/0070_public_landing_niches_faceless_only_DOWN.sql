-- 0070_public_landing_niches_faceless_only_DOWN.sql
-- Rollback for 0070: restore the 0069 definition (is_active + evicted_at gate,
-- WITHOUT the faceless_verdict filter).
--
